...
ggplot(all_df, aes(percent, tempo,fill=facet)) +
  ...
  geom_text(aes(label = percent),nudge_x = 10,color="#b02c57",fontface="bold") +
...
ggsave("graficos_v7/entrega1_tempo_dois.png",width = 20, height = 14, units = "cm")

remove(all_df,tempo_av,tempo_esp)
