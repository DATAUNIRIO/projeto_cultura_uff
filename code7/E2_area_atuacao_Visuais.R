...
ggsave("graficos_v7/entrega2_visuais_area_atuacao_genero.png",width = 20, height = 14, units = "cm")
...
ggsave("graficos_v7/entrega2_visuais_area_atuacao_idade.png",width = 20, height = 14, units = "cm")
