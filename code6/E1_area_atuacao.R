...
ggsave("graficos_v6/entrega1_visual_area_atuacao.png",width = 20, height = 14, units = "cm")
...
ggsave("graficos_v6/entrega1_espetaculo_area_atuacao.png",width = 20, height = 14, units = "cm")
