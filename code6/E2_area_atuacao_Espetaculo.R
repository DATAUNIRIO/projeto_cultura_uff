...
ggsave("graficos_v6/entrega2_espetaculo_area_atuacao_genero.png",width = 20, height = 14, units = "cm")
...
ggsave("graficos_v6/entrega2_espetaculo_area_atuacao_idade.png",width = 20, height = 14, units = "cm")
...
ggsave("graficos_v6/entrega2_espetaculo_area_atuacao_cor.png",width = 20, height = 14, units = "cm")
remove(d) 
...
ggsave("graficos_v6/entrega2_espetaculo_area_atuacao_AP.png",width = 20, height = 14, units = "cm")
