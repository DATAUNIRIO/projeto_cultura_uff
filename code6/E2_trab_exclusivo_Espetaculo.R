...
ggsave("graficos_v6/entrega2_espetaculo_trab_exclusivo_genero.png",width = 20, height = 14, units = "cm")
...
ggsave("graficos_v6/entrega2_espetaculo_trab_exclusivo_idade.png",width = 20, height = 14, units = "cm")
